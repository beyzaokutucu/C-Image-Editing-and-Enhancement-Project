    ...
    public partial class Form1 : Form
    {
        ...
        private void resimAlToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                open.Filter = "ImageFiles(*.jpg; *.jpeg; *.gif; *.gif; *.bmp)|*.jpg; *.jpeg; *.gif, *.bmp";
        ...
        private void griDönüşümToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            OutputImage = new Bitmap(300, 300);

            for (int i = 0; i < InputImage.Width; i++)
            {
                for (int j = 0; j < InputImage.Height; j++)
                {
                    Ortalama = (int)(InputImage.GetPixel(i, j).R * 0.299 + InputImage.GetPixel(i, j).G * 0.587 + InputImage.GetPixel(i, j).B * 0.114);

                    OutputImage.SetPixel(i, j, Color.FromArgb(Ortalama, Ortalama, Ortalama));
                }
            }
        ...
        private void parlaklıkToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            for (int x = 0; x < ResimGenisligi; x++)
            {
                ...
                for (int y = 0; y < ResimYuksekligi; y++)
                {
                    ...
                    if (B > 255) B = 255;
                    DonusenRenk = Color.FromArgb(R, G, B);
                    OutputImage.SetPixel(i, j, DonusenRenk);
                    j++;
                }
                i++;
            }
        ...
        private void siyahbeyazDönüşümToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Bitmap InputImage, OutputImage;
            InputImage = new Bitmap(pictureBox1.Image);
            int ResimGenisligi = InputImage.Width;
            ...
            OutputImage = new Bitmap(ResimGenisligi, ResimYuksekligi);
            Color pixa;
            for (int a = 0; a < ResimYuksekligi; a++)
            {
                for (int b = 0; b < ResimGenisligi; b++)
                {
                    pixa = InputImage.GetPixel(b, a);
                    int ap = pixa.A;
                    int rp = pixa.R;
                    int gp = pixa.G;
                    int bp = pixa.B;
                    int avarage = (rp + gp + bp) / 3;
                    OutputImage.SetPixel(b, a, Color.FromArgb(avarage, avarage, avarage));
                    pictureBox2.Image = OutputImage;
                }
            }
        ...
        private void kontrasToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void aynalamaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text == "")
            {
                MessageBox.Show("Lütfen X1 değerlerini giriniz!!");
            }
            else
            {
                Color OkunanRenk;
        ...
        private void eĞMEKAYDIRMAToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Color OkunanRenk;
            Bitmap GirisResmi, CikisResmi;
            GirisResmi = new Bitmap(pictureBox1.Image);
        ...
        private void resmiKüçültmeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Color OkunanRenk;
            Bitmap GirisResmi, CikisResmi;
            GirisResmi = new Bitmap(pictureBox1.Image);
        ...
        private void resmiBüyültmeToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void ortalamaFiltresiMeanFilterToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void gAUSSBulanıklaştırmaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Color OkunanRenk;
            Bitmap GirisResmi, CikisResmi;
            GirisResmi = new Bitmap(pictureBox1.Image);
        ...
        private void morfolojikİşlemlerToolStripMenuItem_Click(object sender, EventArgs e)
        {

        }

        private void gENISLETMESINIRBULMAToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void ötelemeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Lütfen X1 y1 değerlerini giriniz!!");
            }
            else
            {
                Color OkunanRenk;
        ...
        private void laplasFiltresiToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void kontrasGermeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (textBox1.Text == "" || textBox2.Text == "" || textBox3.Text == "" || textBox4.Text == "")
            {
                MessageBox.Show("Lütfen X ve Y değerlerini giriniz!!");
